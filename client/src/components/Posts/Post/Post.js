...
const Post = ({ post, setCurrentId }) => {
  ...
  const openPost = () => navigate(`/apartments/${post._id}`);
  return (
    <Card>
       ...
       <div>
        ...
        <CardContent>
          ...
          <div align="left">
            ...
            <Typography variant="subtitle2">Time to Campus: {post.travelTime} mins</Typography>
            <Typography variant="body2" color="textSecondary">Parking: {post.parking}</Typography>
            <Typography variant="body2" color="textSecondary">Room Type: {post.roomType}</Typography>
            <Typography variant="body2" color="textSecondary">Lease Type: {post.leaseType}</Typography>
          </div>
        </CardContent>
       </div>
      </ButtonBase>
